...
public class Constants {
    ...
    public static final float SPLEEN_SCALE = 1f *GLOBAL_SCALE;
    ...
    public static final Vector2 SPLEEN_POSITION = new Vector2(65, 59f);
    ...
    public static final float SPLEEN_TUMOR_SCALE = 0.5f*TUMOR_SCALE;
    ...
    public static final int MASK_ABDOMINALWALL = 0 ; //CATEGORY_ABDOMINALWALL | CATEGORY_SPLEEN | CATEGORY_ESOPHAGUS | CATEGORY_DUODENUM
            //| CATEGORY_RECTUM | CATEGORY_STOMACH | CATEGORY_COLON | CATEGORY_APPENDIX | CATEGORY_SMALLINTESTINE |  CATEGORY_LIVER ;
    public static final int MASK_ESOPHAGUS = CATEGORY_ABDOMINALWALL | CATEGORY_SPLEEN | CATEGORY_ESOPHAGUS | CATEGORY_LIVER;
    public static final int MASK_BILEDUCT = CATEGORY_ABDOMINALWALL | CATEGORY_SPLEEN | CATEGORY_BILEDUCT | CATEGORY_GALLBLADDER | CATEGORY_LIVER;
    public static final int MASK_GALLBLADDER = CATEGORY_ABDOMINALWALL | CATEGORY_SPLEEN | CATEGORY_GALLBLADDER | CATEGORY_BILEDUCT | CATEGORY_LIVER;
    public static final int MASK_PANCREAS = CATEGORY_ABDOMINALWALL | CATEGORY_SPLEEN | CATEGORY_PANCREAS | CATEGORY_DUODENUM | CATEGORY_LIVER;
    public static final int MASK_DUODENUM = CATEGORY_ABDOMINALWALL | CATEGORY_SPLEEN | CATEGORY_DUODENUM | CATEGORY_LIVER;
    public static final int MASK_RECTUM = CATEGORY_ABDOMINALWALL | CATEGORY_SPLEEN | CATEGORY_RECTUM | CATEGORY_COLON | CATEGORY_SMALLINTESTINE | CATEGORY_LIVER;
    public static final int MASK_STOMACH = CATEGORY_ABDOMINALWALL | CATEGORY_SPLEEN | CATEGORY_STOMACH | CATEGORY_LIVER;
    public static final int MASK_COLON = CATEGORY_ABDOMINALWALL | CATEGORY_SPLEEN | CATEGORY_COLON | CATEGORY_APPENDIX | CATEGORY_RECTUM | CATEGORY_LIVER;
    public static final int MASK_APPENDIX = CATEGORY_ABDOMINALWALL | CATEGORY_SPLEEN | CATEGORY_COLON | CATEGORY_APPENDIX | CATEGORY_SMALLINTESTINE | CATEGORY_LIVER;
    public static final int MASK_SMALLINTESTINE = CATEGORY_ABDOMINALWALL | CATEGORY_SPLEEN | CATEGORY_APPENDIX | CATEGORY_SMALLINTESTINE | CATEGORY_RECTUM | CATEGORY_LIVER;
    public static final int MASK_LIVER = CATEGORY_ABDOMINALWALL | CATEGORY_SPLEEN | CATEGORY_ESOPHAGUS | CATEGORY_DUODENUM | CATEGORY_RECTUM | CATEGORY_STOMACH | CATEGORY_COLON
                                        | CATEGORY_APPENDIX | CATEGORY_SMALLINTESTINE | CATEGORY_LIVER;
    public static final int MASK_SPLEEN = CATEGORY_ABDOMINALWALL | CATEGORY_SPLEEN | CATEGORY_ESOPHAGUS | CATEGORY_DUODENUM | CATEGORY_RECTUM | CATEGORY_STOMACH | CATEGORY_COLON
            | CATEGORY_APPENDIX | CATEGORY_SMALLINTESTINE | CATEGORY_LIVER;
