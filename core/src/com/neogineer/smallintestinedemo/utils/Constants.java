...
public class Constants {
    ...
    public static final int MASK_ABDOMINALWALL = CATEGORY_ABDOMINALWALL | CATEGORY_ABDOMINALCONNECTOR | CATEGORY_SPLEEN
            | CATEGORY_PANCREAS | CATEGORY_GALLBLADDER | CATEGORY_BILEDUCT | CATEGORY_DUODENUM
            | CATEGORY_RECTUM | CATEGORY_STOMACH | CATEGORY_COLON | CATEGORY_APPENDIX | CATEGORY_SMALLINTESTINE |  CATEGORY_LIVER ;
    public static final int MASK_ESOPHAGUS = CATEGORY_ABDOMINALCONNECTOR | CATEGORY_SPLEEN | CATEGORY_ESOPHAGUS | CATEGORY_LIVER;
    public static final int MASK_BILEDUCT = CATEGORY_ABDOMINALWALL | CATEGORY_ABDOMINALCONNECTOR | CATEGORY_SPLEEN | CATEGORY_BILEDUCT | CATEGORY_GALLBLADDER;
    ...
    public static final int MASK_STOMACH = CATEGORY_ABDOMINALWALL | CATEGORY_ABDOMINALCONNECTOR | CATEGORY_PANCREAS | CATEGORY_SPLEEN | CATEGORY_STOMACH | CATEGORY_LIVER;
    public static final int MASK_COLON = CATEGORY_ABDOMINALWALL | CATEGORY_ABDOMINALCONNECTOR | CATEGORY_PANCREAS | CATEGORY_SPLEEN | CATEGORY_COLON | CATEGORY_APPENDIX | CATEGORY_RECTUM | CATEGORY_LIVER;
    ...
    public static final int MASK_SMALLINTESTINE = CATEGORY_ABDOMINALWALL | CATEGORY_ABDOMINALCONNECTOR | CATEGORY_PANCREAS | CATEGORY_SPLEEN | CATEGORY_APPENDIX | CATEGORY_SMALLINTESTINE | CATEGORY_RECTUM | CATEGORY_LIVER;
    public static final int MASK_LIVER = CATEGORY_ABDOMINALWALL | CATEGORY_ABDOMINALCONNECTOR | CATEGORY_SPLEEN
            | CATEGORY_PANCREAS | CATEGORY_GALLBLADDER | CATEGORY_ESOPHAGUS | CATEGORY_DUODENUM
            | CATEGORY_RECTUM | CATEGORY_STOMACH | CATEGORY_COLON | CATEGORY_APPENDIX | CATEGORY_SMALLINTESTINE |  CATEGORY_LIVER ;
    public static final int MASK_SPLEEN = MASK_ABDOMINALWALL;
