...
public class Constants {
    ...
    public static final int MASK_ABDOMINALWALL = 0 ; //CATEGORY_ABDOMINALWALL | CATEGORY_ABDOMINALCONNECTOR | CATEGORY_SPLEEN | CATEGORY_ESOPHAGUS | CATEGORY_DUODENUM
    ...
    public static final int MASK_APPENDIX = 0;//CATEGORY_ABDOMINALWALL | CATEGORY_ABDOMINALCONNECTOR | CATEGORY_SPLEEN | CATEGORY_COLON | CATEGORY_APPENDIX | CATEGORY_SMALLINTESTINE | CATEGORY_LIVER;
    ...
    public static final int MASK_SPLEEN = CATEGORY_ABDOMINALWALL | CATEGORY_ABDOMINALCONNECTOR | CATEGORY_SPLEEN | CATEGORY_ESOPHAGUS | CATEGORY_DUODENUM | CATEGORY_RECTUM | CATEGORY_STOMACH | CATEGORY_COLON
                                        | CATEGORY_APPENDIX | CATEGORY_SMALLINTESTINE | CATEGORY_LIVER;
    public static final int MASK_ABDOMINALCONNECTOR = CATEGORY_ABDOMINALWALL | CATEGORY_ABDOMINALCONNECTOR | CATEGORY_SPLEEN | CATEGORY_ESOPHAGUS | CATEGORY_DUODENUM | CATEGORY_RECTUM | CATEGORY_STOMACH | CATEGORY_COLON
            | CATEGORY_APPENDIX | CATEGORY_SMALLINTESTINE | CATEGORY_LIVER;
