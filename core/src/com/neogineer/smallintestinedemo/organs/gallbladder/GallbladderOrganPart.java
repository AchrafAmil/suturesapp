 ...
 */
public class GallbladderOrganPart extends OrganPart {
    ...
    public GallbladderOrganPart(OrganPartDefinition opDef) {
        super(opDef);
        setupBody("GallbladderOrganPart.json");
    }
    ...
    public short getCategory() {
        return Constants.CATEGORY_GALLBLADDER;
    }

    @Override
    public short getMask() {
        return Constants.MASK_GALLBLADDER;
    }
