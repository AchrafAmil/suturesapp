 ...
 */
public class Rectum extends com.neogineer.smallintestinedemo.organs.Organ {
    ...
    public Rectum(World world, OrthographicCamera camera) {
        ...
        for(int i=1; i<=SIZE; i++){
            com.neogineer.smallintestinedemo.organs.OrganPart part = new RectumOrganPart(world, camera, this, ""+i, SCALE, getOrganPartPosition(i),0);
    ...
    public void loadState(Kryo kryo, Input input){
        ...
        for(int i=1; i<=SIZE; i++){
            com.neogineer.smallintestinedemo.organs.OrganPart op = kryo.readObject(input, RectumOrganPart.class);
