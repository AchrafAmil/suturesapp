...
public class ColonOrganPart extends RopeOrganPart {
    ...
    protected float getHorizontalSuturePointPosition(Vector2 vec) {
        return HORIZONTAL_SUTUREPOINT_POSITION * ((com.suturesapp.smallintestinedemo.utils.Utils.getRegion(vec)>4)? 2.8f:1);
    }
    ...
    public boolean isVeryMiddle(){
        ...
        for(SuturePoint sp: suturePoints){
            com.suturesapp.smallintestinedemo.organs.OrganPart other = sp.getTheOtherOrganPart();
