 ...
 */
public class Colon extends com.suturesapp.smallintestinedemo.organs.Organ {
    ...
    public Colon(World world, OrthographicCamera camera, Vector2 startPos, Vector2 endPos){
        ...
        for(int i = 0; i< getLENGTH(); i++){
            ...
            connector.organA = (com.suturesapp.smallintestinedemo.organs.OrganPart) link.getUserData();
            connector.anchorA = new Vector2(0, JOINT_OFFSET);
            connector.organB = (com.suturesapp.smallintestinedemo.organs.OrganPart) body.getUserData();
    ...
    public void loadState(Kryo kryo, Input input){
        ...
        for(int i = 0; i<= getLENGTH(); i++){
            com.suturesapp.smallintestinedemo.organs.OrganPart op = kryo.readObject(input, ColonOrganPart.class);
