package com.suturesapp.smallintestinedemo.organs.liver;
...
public class Liver extends Organ {
    ...
    public Liver(World world, OrthographicCamera camera) {
        ...
        JSONArray joints = com.suturesapp.smallintestinedemo.utils.Utils.loadJoints("liver_initial_joints.json");
