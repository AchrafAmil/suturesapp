 ...
 */
public class AppendixOrganPart extends com.suturesapp.smallintestinedemo.organs.OrganPart {


    public AppendixOrganPart(World world, OrthographicCamera camera, com.suturesapp.smallintestinedemo.organs.Organ callback, String identifier, float scale, Vector2 position, float rotation) {
