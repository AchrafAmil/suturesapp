...
import com.suturesapp.smallintestinedemo.organs.rectum.Rectum;
import com.suturesapp.smallintestinedemo.organs.rope.Colon;
...
import com.suturesapp.smallintestinedemo.organs.liver.Liver;
...
public class OrgansHolder {
    ...
    public com.suturesapp.smallintestinedemo.organs.abdominalwall.AbdominalWall abdominalWall;

    public com.suturesapp.smallintestinedemo.organs.esophagus.Esophagus esophagus;

    public com.suturesapp.smallintestinedemo.organs.duedenum.Duodenum duodenum;

    public Rectum rectum;

    public com.suturesapp.smallintestinedemo.organs.stomach.Stomach stomach;

    public Colon colon;

    public com.suturesapp.smallintestinedemo.organs.appendix.Appendix appendix;
    ...
    public void start(final com.suturesapp.smallintestinedemo.GameStage stage){
        if(world==null || camera==null)
            throw new RuntimeException("Holder can't start, World and/or Camera are null");

        this.abdominalWall = new com.suturesapp.smallintestinedemo.organs.abdominalwall.AbdominalWall(world, camera);
        stage.addActor(this.abdominalWall);
        allOrgans.put("AbdominalWall", abdominalWall);

        this.esophagus = new com.suturesapp.smallintestinedemo.organs.esophagus.Esophagus(world, camera);
        stage.addActor(this.esophagus);
        allOrgans.put("Esophagus", esophagus);

        this.duodenum = new com.suturesapp.smallintestinedemo.organs.duedenum.Duodenum(world, camera);
        ...
        this.stomach = new com.suturesapp.smallintestinedemo.organs.stomach.Stomach(world, camera);
        ...
        this.appendix = new com.suturesapp.smallintestinedemo.organs.appendix.Appendix(world, camera);
            ...
            public void run() {
                try {
                    ...
                    Gdx.app.postRunnable(new Runnable() {
                        @Override
                        public void run() {
                            camera.translate(com.suturesapp.smallintestinedemo.utils.Constants.CAMERA_INITIAL_TRANSLATION);
                            camera.update();
                        }
                    });
    ...
    private void setupExternalJoints(World world, OrthographicCamera camera){
        ...
        JSONArray joints = com.suturesapp.smallintestinedemo.utils.Utils.loadJoints("external_joints.json");
    ...
    private void saveJoints(Kryo kryo, Output output){
        ...
        for(Joint joint : joints)
            spDefs.add(com.suturesapp.smallintestinedemo.utils.Utils.jointToSpDef(joint));
