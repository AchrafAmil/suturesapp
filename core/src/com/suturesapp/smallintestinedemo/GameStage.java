...
import com.suturesapp.smallintestinedemo.organs.appendix.AppendixOrganPart;
...
import com.suturesapp.smallintestinedemo.organs.rope.ColonOrganPart;
...
import com.suturesapp.smallintestinedemo.organs.stomach.StomachOrganPart;
...
public class GameStage extends Stage{
    ...
    private void setupKryo() {
        ...
        kryo.register(StomachOrganPart.class, new Serializer<com.suturesapp.smallintestinedemo.organs.OrganPart>() {
            @Override
            public void write(Kryo kryo, Output output, com.suturesapp.smallintestinedemo.organs.OrganPart op) {
                kryo.writeObject(output, op.getOPDef());
            }

            @Override
            public com.suturesapp.smallintestinedemo.organs.OrganPart read(Kryo kryo, Input input, Class<com.suturesapp.smallintestinedemo.organs.OrganPart> type) {
                OrganPartDefinition opDef = kryo.readObject(input, OrganPartDefinition.class);
                return new StomachOrganPart(opDef);
            }
        });

        kryo.register(RectumOrganPart.class, new Serializer<com.suturesapp.smallintestinedemo.organs.OrganPart>() {
            @Override
            public void write(Kryo kryo, Output output, com.suturesapp.smallintestinedemo.organs.OrganPart op) {
                kryo.writeObject(output, op.getOPDef());
            }
        ...
        kryo.register(com.suturesapp.smallintestinedemo.organs.duedenum.DuodenumOrganPart.class, new Serializer<com.suturesapp.smallintestinedemo.organs.OrganPart>() {
            @Override
            public void write(Kryo kryo, Output output, com.suturesapp.smallintestinedemo.organs.OrganPart op) {
                kryo.writeObject(output, op.getOPDef());
            }
            ...
            public com.suturesapp.smallintestinedemo.organs.OrganPart read(Kryo kryo, Input input, Class<com.suturesapp.smallintestinedemo.organs.OrganPart> type) {
                OrganPartDefinition opDef = kryo.readObject(input, OrganPartDefinition.class);
                return new com.suturesapp.smallintestinedemo.organs.duedenum.DuodenumOrganPart(opDef);
            }
        });

        kryo.register(EsophagusOrganPart.class, new Serializer<com.suturesapp.smallintestinedemo.organs.OrganPart>() {
            @Override
            public void write(Kryo kryo, Output output, com.suturesapp.smallintestinedemo.organs.OrganPart op) {
                kryo.writeObject(output, op.getOPDef());
            }
        ...
        kryo.register(com.suturesapp.smallintestinedemo.organs.liver.LiverOrganPart.class, new Serializer<com.suturesapp.smallintestinedemo.organs.OrganPart>() {
            @Override
            public void write(Kryo kryo, Output output, com.suturesapp.smallintestinedemo.organs.OrganPart op) {
                kryo.writeObject(output, op.getOPDef());
            }
            ...
            public com.suturesapp.smallintestinedemo.organs.OrganPart read(Kryo kryo, Input input, Class<com.suturesapp.smallintestinedemo.organs.OrganPart> type) {
                OrganPartDefinition opDef = kryo.readObject(input, OrganPartDefinition.class);
                return new com.suturesapp.smallintestinedemo.organs.liver.LiverOrganPart(opDef);
            }
        });

        kryo.register(com.suturesapp.smallintestinedemo.organs.rope.SmallIntestineOrganPart.class, new Serializer<com.suturesapp.smallintestinedemo.organs.OrganPart>() {
            @Override
            public void write(Kryo kryo, Output output, com.suturesapp.smallintestinedemo.organs.OrganPart op) {
                kryo.writeObject(output, op.getOPDef());
            }
            ...
            public com.suturesapp.smallintestinedemo.organs.OrganPart read(Kryo kryo, Input input, Class<com.suturesapp.smallintestinedemo.organs.OrganPart> type) {
                OrganPartDefinition opDef = kryo.readObject(input, OrganPartDefinition.class);
                return new com.suturesapp.smallintestinedemo.organs.rope.SmallIntestineOrganPart(opDef);
            }
        });

        kryo.register(AppendixOrganPart.class, new Serializer<com.suturesapp.smallintestinedemo.organs.OrganPart>() {
            @Override
            public void write(Kryo kryo, Output output, com.suturesapp.smallintestinedemo.organs.OrganPart op) {
                kryo.writeObject(output, op.getOPDef());
            }
        ...
        kryo.register(ColonOrganPart.class, new Serializer<com.suturesapp.smallintestinedemo.organs.OrganPart>() {
            @Override
            public void write(Kryo kryo, Output output, com.suturesapp.smallintestinedemo.organs.OrganPart op) {
                kryo.writeObject(output, op.getOPDef());
            }
        ...
        kryo.register(AbdominalWallOrganPart.class, new Serializer<com.suturesapp.smallintestinedemo.organs.OrganPart>() {
            @Override
            public void write(Kryo kryo, Output output, com.suturesapp.smallintestinedemo.organs.OrganPart op) {
                kryo.writeObject(output, op.getOPDef());
            }
    ...
    private void setupCamera(){
        camera = new OrthographicCamera(com.suturesapp.smallintestinedemo.utils.Constants.VIEWPORT_WIDTH, com.suturesapp.smallintestinedemo.utils.Constants.VIEWPORT_HEIGHT);
        camera.zoom = com.suturesapp.smallintestinedemo.utils.Constants.INITIAL_ZOOM;
    ...
    public void setTool(com.suturesapp.smallintestinedemo.tools.Tool tool){
        ...
        for(int i = 0; i<size; i++){
            ...
            if(ip instanceof com.suturesapp.smallintestinedemo.tools.Tool || ip instanceof GestureDetector)
    ...
    public void draw() {
        ...
        super.draw();
        if(com.suturesapp.smallintestinedemo.utils.Constants.ENABLE_DEBUG)
    ...
    public boolean keyDown(int keyCode) {
        ...
        switch (keyCode){
            ...
            case 22:
                ...
                break;
            case 129:
                com.suturesapp.smallintestinedemo.utils.Constants.ENABLE_DEBUG = !com.suturesapp.smallintestinedemo.utils.Constants.ENABLE_DEBUG;
                break;
            default:
