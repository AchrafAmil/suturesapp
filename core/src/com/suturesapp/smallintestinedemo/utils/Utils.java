package com.suturesapp.smallintestinedemo.utils;
...
import com.suturesapp.smallintestinedemo.organs.abdominalwall.AbdominalWall;
import com.suturesapp.smallintestinedemo.organs.appendix.Appendix;
import com.suturesapp.smallintestinedemo.organs.esophagus.Esophagus;
...
import com.suturesapp.smallintestinedemo.organs.rope.SmallIntestineOrganPart;
import com.suturesapp.smallintestinedemo.organs.duedenum.Duodenum;
import com.suturesapp.smallintestinedemo.organs.stomach.Stomach;
...
public class Utils {
    ...
    public static SuturePointDef jointToSpDef(Joint j){
        ...
        if(orgA instanceof com.suturesapp.smallintestinedemo.organs.rope.RopeOrganPart)
            spDef.idA = ((com.suturesapp.smallintestinedemo.organs.rope.RopeOrganPart)orgA).id;
        if(orgB instanceof com.suturesapp.smallintestinedemo.organs.rope.RopeOrganPart)
            spDef.idB = ((com.suturesapp.smallintestinedemo.organs.rope.RopeOrganPart)orgB).id;
