...
import com.suturesapp.workspace.organs.liver.LiverOrganPart;
...
public class GameStage extends Stage{
    ...
    private void setupKryo() {
        ...
        kryo.register(com.suturesapp.workspace.organs.rectum.RectumOrganPart.class, new Serializer<OrganPart>() {
            @Override
            public void write(Kryo kryo, Output output, OrganPart op) {
                kryo.writeObject(output, op.getOPDef());
            }
        ...
        kryo.register(com.suturesapp.workspace.organs.esophagus.EsophagusOrganPart.class, new Serializer<OrganPart>() {
            @Override
            public void write(Kryo kryo, Output output, OrganPart op) {
                kryo.writeObject(output, op.getOPDef());
            }
            ...
            public OrganPart read(Kryo kryo, Input input, Class<OrganPart> type) {
                com.suturesapp.workspace.organs.OrganPartDefinition opDef = kryo.readObject(input, com.suturesapp.workspace.organs.OrganPartDefinition.class);
                return new com.suturesapp.workspace.organs.esophagus.EsophagusOrganPart(opDef);
            }
        });
        ...
        kryo.register(com.suturesapp.workspace.organs.appendix.AppendixOrganPart.class, new Serializer<OrganPart>() {
            @Override
            public void write(Kryo kryo, Output output, OrganPart op) {
                kryo.writeObject(output, op.getOPDef());
            }
        ...
        kryo.register(com.suturesapp.workspace.organs.rope.ColonOrganPart.class, new Serializer<OrganPart>() {
            @Override
            public void write(Kryo kryo, Output output, OrganPart op) {
                kryo.writeObject(output, op.getOPDef());
            }
            ...
            public OrganPart read(Kryo kryo, Input input, Class<OrganPart> type) {
                com.suturesapp.workspace.organs.OrganPartDefinition opDef = kryo.readObject(input, com.suturesapp.workspace.organs.OrganPartDefinition.class);
                return new com.suturesapp.workspace.organs.rope.ColonOrganPart(opDef);
            }
        });

        kryo.register(com.suturesapp.workspace.organs.abdominalwall.AbdominalWallOrganPart.class, new Serializer<OrganPart>() {
            @Override
            public void write(Kryo kryo, Output output, OrganPart op) {
                kryo.writeObject(output, op.getOPDef());
            }
    ...
    private void setupInputMultiplexer(){
        ...
        setTool(new com.suturesapp.workspace.tools.DndTool(world, camera,groundBody));
    }
    ...
    public void setTool(Tool tool){
        ...
        if(tool instanceof com.suturesapp.workspace.tools.DndTool)
            this.inputMultiplexer.addProcessor(new GestureDetector((com.suturesapp.workspace.tools.DndTool)tool));
    }
    ...
    private void clickedA(){
        ...
        switch (clicksA%4){
            case 0:
                ...
                break;
            case 1:
                setTool(new com.suturesapp.workspace.tools.CutTool(world, camera));
                Gdx.app.log("keyDown", "Cut tool");
                break;
            case 2:
                setTool(new com.suturesapp.workspace.tools.CloseTool(world, camera));
                Gdx.app.log("keyDown", "Close tool");
                break;
            case 3:
                setTool(new com.suturesapp.workspace.tools.ConnectTool(world, camera));
