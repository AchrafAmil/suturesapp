...
//                op.destroy();
    ...
    private SuturePoint getConcernedSuturePoint(){
        ...
        if(organPart instanceof com.suturesapp.workspace.organs.rope.RopeOrganPart)
            if(!((com.suturesapp.workspace.organs.rope.RopeOrganPart) organPart).isVeryMiddle())
                return null;
