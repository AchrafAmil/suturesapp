...
public class ColonOrganPart extends RopeOrganPart {
    ...
    public ColonOrganPart(World world, OrthographicCamera camera, com.suturesapp.workspace.organs.Organ callback, int id, float scale, Vector2 position, float rotation) {
