...
public class SmallIntestineOrganPart extends RopeOrganPart {
    ...
    public SmallIntestineOrganPart(World world, OrthographicCamera camera, com.suturesapp.workspace.organs.Organ callback, int id, float scale, Vector2 position, float rotation) {
    ...
    public short getCategory() {
        return com.suturesapp.workspace.utils.Constants.CATEGORY_SMALLINTESTINE;
    }

    @Override
    public short getMask() {
        return com.suturesapp.workspace.utils.Constants.MASK_SMALLINTESTINE;
    }
}
