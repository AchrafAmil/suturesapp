 ...
 */
public class Liver extends com.suturesapp.workspace.organs.Organ {

    public static final float SCALE = com.suturesapp.workspace.utils.Constants.LIVER_SCALE;

    public static final Vector2 POSITION = com.suturesapp.workspace.utils.Constants.LIVER_POSITION;
    ...
    public Liver(World world, OrthographicCamera camera) {
        ...
        for(int i=1; i<=SIZE; i++){
            com.suturesapp.workspace.organs.OrganPart part = new LiverOrganPart(world, camera, this, ""+i, SCALE, getOrganPartPosition(i), 0);
    ...
    public void loadState(Kryo kryo, Input input){
        ...
        for(int i=1; i<=SIZE; i++){
            com.suturesapp.workspace.organs.OrganPart op = kryo.readObject(input, LiverOrganPart.class);
