...
public class OrgansHolder {
    ...
    public com.suturesapp.workspace.organs.rectum.Rectum rectum;

    public Stomach stomach;

    public com.suturesapp.workspace.organs.rope.Colon colon;

    public Appendix appendix;

    public com.suturesapp.workspace.organs.rope.SmallIntestine smallIntestine;
    ...
    public void start(final GameStage stage){
        ...
        this.rectum = new com.suturesapp.workspace.organs.rectum.Rectum(world, camera);
        ...
        this.colon = new com.suturesapp.workspace.organs.rope.Colon(world, camera);
        ...
        this.smallIntestine = new com.suturesapp.workspace.organs.rope.SmallIntestine(world, camera);
