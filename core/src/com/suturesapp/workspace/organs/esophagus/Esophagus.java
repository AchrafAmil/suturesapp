 ...
 */
public class Esophagus extends com.suturesapp.workspace.organs.Organ {

    public static final float SCALE = com.suturesapp.workspace.utils.Constants.ESOPHAGUS_SCALE;

    public static final Vector2 POSITION = com.suturesapp.workspace.utils.Constants.ESOPHAGUS_POSITION;
    ...
    public Esophagus(World world, OrthographicCamera camera) {
        ...
        for(int i=1; i<=SIZE; i++){
            com.suturesapp.workspace.organs.OrganPart part = new EsophagusOrganPart(world, camera, this, ""+i, SCALE, getOrganPartPosition(i), 0);
        ...
        for(int i=0; i<joints.length(); i++){
                ...
                com.suturesapp.workspace.tools.ConnectTool tool = new com.suturesapp.workspace.tools.ConnectTool(world, camera);
    ...
    public void loadState(Kryo kryo, Input input){
        ...
        for(int i=1; i<=SIZE; i++){
            com.suturesapp.workspace.organs.OrganPart op = kryo.readObject(input, EsophagusOrganPart.class);
